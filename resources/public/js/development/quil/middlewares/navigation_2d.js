...
return cljs.core.merge.call(null,initial_state,p1__2334_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_2335 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_2336 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_2335);
var pos_2337 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_2335);
quil.core.scale.call(null,zoom_2336);

var tr__2238__auto___2338 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_2336) - cljs.core.first.call(null,pos_2337)),(((quil.core.height.call(null) / (2)) / zoom_2336) - cljs.core.second.call(null,pos_2337))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__2238__auto___2338);
