...
var vec__36149 = axis;
var a_x = cljs.core.nth.call(null,vec__36149,(0),null);
var a_y = cljs.core.nth.call(null,vec__36149,(1),null);
var a_z = cljs.core.nth.call(null,vec__36149,(2),null);
var vec__36152 = v;
var x = cljs.core.nth.call(null,vec__36152,(0),null);
var y = cljs.core.nth.call(null,vec__36152,(1),null);
var z = cljs.core.nth.call(null,vec__36152,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__36155,p__36156){
var vec__36157 = p__36155;
var u1 = cljs.core.nth.call(null,vec__36157,(0),null);
var u2 = cljs.core.nth.call(null,vec__36157,(1),null);
var u3 = cljs.core.nth.call(null,vec__36157,(2),null);
var vec__36160 = p__36156;
var v1 = cljs.core.nth.call(null,vec__36160,(0),null);
var v2 = cljs.core.nth.call(null,vec__36160,(1),null);
var v3 = cljs.core.nth.call(null,vec__36160,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__36163_SHARP_){
return (p1__36163_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__36164_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__36165_SHARP_,angle_lr),angle_ud);
...
var map__36167 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__36167__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__36167__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__36169 = cljs.core._EQ_;
var expr__36170 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__36169.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__36170))){
return straight;
} else {
if(cljs.core.truth_(pred__36169.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__36170))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__36169.call(null,quil.middlewares.navigation_3d.space,expr__36170))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__36169.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__36170))){
return up;
} else {
if(cljs.core.truth_(pred__36169.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__36170))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__36169.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__36170))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__36167,map__36167__$1,up,straight){
return (function (p1__36166_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__36166_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__36167,map__36167__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__36172_SHARP_);
});})(initial_state))
);
});
/**
...
var map__36173_36184 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__36173_36185__$1 = (((((!((map__36173_36184 == null))))?(((((map__36173_36184.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36173_36184.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36173_36184):map__36173_36184);
var vec__36174_36186 = cljs.core.get.call(null,map__36173_36185__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_36187 = cljs.core.nth.call(null,vec__36174_36186,(0),null);
var c_y_36188 = cljs.core.nth.call(null,vec__36174_36186,(1),null);
var c_z_36189 = cljs.core.nth.call(null,vec__36174_36186,(2),null);
var vec__36177_36190 = cljs.core.get.call(null,map__36173_36185__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_36191 = cljs.core.nth.call(null,vec__36177_36190,(0),null);
var u_y_36192 = cljs.core.nth.call(null,vec__36177_36190,(1),null);
var u_z_36193 = cljs.core.nth.call(null,vec__36177_36190,(2),null);
var vec__36180_36194 = cljs.core.get.call(null,map__36173_36185__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_36195 = cljs.core.nth.call(null,vec__36180_36194,(0),null);
var p_y_36196 = cljs.core.nth.call(null,vec__36180_36194,(1),null);
var p_z_36197 = cljs.core.nth.call(null,vec__36180_36194,(2),null);
quil.core.camera.call(null,p_x_36195,p_y_36196,p_z_36197,(p_x_36195 + c_x_36187),(p_y_36196 + c_y_36188),(p_z_36197 + c_z_36189),u_x_36191,u_y_36192,u_z_36193);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1561561422756
