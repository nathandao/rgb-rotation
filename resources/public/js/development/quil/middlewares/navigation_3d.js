...
var vec__1794 = axis;
var a_x = cljs.core.nth.call(null,vec__1794,(0),null);
var a_y = cljs.core.nth.call(null,vec__1794,(1),null);
var a_z = cljs.core.nth.call(null,vec__1794,(2),null);
var vec__1797 = v;
var x = cljs.core.nth.call(null,vec__1797,(0),null);
var y = cljs.core.nth.call(null,vec__1797,(1),null);
var z = cljs.core.nth.call(null,vec__1797,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__1800,p__1801){
var vec__1802 = p__1800;
var u1 = cljs.core.nth.call(null,vec__1802,(0),null);
var u2 = cljs.core.nth.call(null,vec__1802,(1),null);
var u3 = cljs.core.nth.call(null,vec__1802,(2),null);
var vec__1805 = p__1801;
var v1 = cljs.core.nth.call(null,vec__1805,(0),null);
var v2 = cljs.core.nth.call(null,vec__1805,(1),null);
var v3 = cljs.core.nth.call(null,vec__1805,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__1808_SHARP_){
return (p1__1808_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__1809_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__1809_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__1810_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__1810_SHARP_,angle_lr),angle_ud);
...
var map__1812 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1812__$1 = (((((!((map__1812 == null))))?(((((map__1812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1812):map__1812);
var up = cljs.core.get.call(null,map__1812__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__1812__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__1814 = cljs.core._EQ_;
var expr__1815 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__1814.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__1815))){
return straight;
} else {
if(cljs.core.truth_(pred__1814.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__1815))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__1814.call(null,quil.middlewares.navigation_3d.space,expr__1815))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__1814.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__1815))){
return up;
} else {
if(cljs.core.truth_(pred__1814.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__1815))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__1814.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__1815))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__1812,map__1812__$1,up,straight){
return (function (p1__1811_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__1811_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__1812,map__1812__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__1817_SHARP_);
});})(initial_state))
);
});
/**
...
var map__1818_1829 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1818_1830__$1 = (((((!((map__1818_1829 == null))))?(((((map__1818_1829.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1818_1829.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1818_1829):map__1818_1829);
var vec__1819_1831 = cljs.core.get.call(null,map__1818_1830__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_1832 = cljs.core.nth.call(null,vec__1819_1831,(0),null);
var c_y_1833 = cljs.core.nth.call(null,vec__1819_1831,(1),null);
var c_z_1834 = cljs.core.nth.call(null,vec__1819_1831,(2),null);
var vec__1822_1835 = cljs.core.get.call(null,map__1818_1830__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_1836 = cljs.core.nth.call(null,vec__1822_1835,(0),null);
var u_y_1837 = cljs.core.nth.call(null,vec__1822_1835,(1),null);
var u_z_1838 = cljs.core.nth.call(null,vec__1822_1835,(2),null);
var vec__1825_1839 = cljs.core.get.call(null,map__1818_1830__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_1840 = cljs.core.nth.call(null,vec__1825_1839,(0),null);
var p_y_1841 = cljs.core.nth.call(null,vec__1825_1839,(1),null);
var p_z_1842 = cljs.core.nth.call(null,vec__1825_1839,(2),null);
quil.core.camera.call(null,p_x_1840,p_y_1841,p_z_1842,(p_x_1840 + c_x_1832),(p_y_1841 + c_y_1833),(p_z_1842 + c_z_1834),u_x_1836,u_y_1837,u_z_1838);
